...
apex-agent backlog export                     # DB → docs/BACKLOG.md + BACKLOG_HISTORY.md 직접 쓰기
apex-agent backlog export --stdout            # stdout 출력 (디버깅용)
...
- import-first 안전장치 포함 (DB 유실 시 MD에서 자동 복원)
