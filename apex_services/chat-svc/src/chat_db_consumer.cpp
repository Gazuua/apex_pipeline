    ...
    int64_t /*offset*/)
{
    ...
    auto sender_name = msg->sender_name() ? msg->sender_name()->string_view()
                                          : std::string_view{};
    auto content     = msg->content() ? msg->content()->string_view()
                                      : std::string_view{};
    ...
    spdlog::info("[ChatDbConsumer] Persisting message: room={}, sender={}, ts={}",
