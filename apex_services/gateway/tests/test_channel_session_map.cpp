...
TEST(ChannelSessionMap, SubscribeAndGet)
{
    ...
    ASSERT_TRUE(map.subscribe("pub:chat:room:1", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("pub:chat:room:1", make_session_id(200)).has_value());
...
TEST(ChannelSessionMap, PerCoreLocalSubscribers)
{
    ...
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(200)).has_value());
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(300)).has_value());
...
TEST(ChannelSessionMap, Unsubscribe)
{
    ...
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(200)).has_value());
    map.unsubscribe("ch1", make_session_id(100));
...
TEST(ChannelSessionMap, UnsubscribeAll)
{
    ChannelSessionMap map;
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("ch2", make_session_id(100)).has_value());
    map.unsubscribe_all(make_session_id(100));
...
TEST(ChannelSessionMap, DuplicateSubscribe)
{
    ChannelSessionMap map;
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(100)).has_value()); // Duplicate — still ok
...
TEST(ChannelSessionMap, UnsubscribeFromEmptyChannel)
{
    ChannelSessionMap map;
    // Should not crash
    map.unsubscribe("nonexistent", make_session_id(100));
    map.unsubscribe_all(make_session_id(999));
}
...
TEST(ChannelSessionMap, SubscriptionLimitExceeded)
{
    ...
    ASSERT_TRUE(map.subscribe("ch1", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("ch2", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("ch3", make_session_id(100)).has_value());
...
TEST(ChannelSessionMap, SubscriptionLimitZeroMeansUnlimited)
{
    ...
    for (int i = 0; i < 100; ++i)
    {
        ASSERT_TRUE(map.subscribe("ch" + std::to_string(i), make_session_id(100)).has_value());
    }
}
...
TEST(ChannelSessionMap, SubscriptionLimitUnsubscribeFreesSlot)
{
    ...
    ASSERT_FALSE(map.subscribe("ch3", make_session_id(100)).has_value());
...
{
    ChannelSessionMap map;
    ASSERT_TRUE(map.subscribe("alpha", make_session_id(100)).has_value());
    ASSERT_TRUE(map.subscribe("beta", make_session_id(200)).has_value());
    ASSERT_TRUE(map.subscribe("alpha", make_session_id(300)).has_value());
