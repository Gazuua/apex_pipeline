...
- Create: `include/apex/core/.gitkeep`
- Create: `src/.gitkeep`
- Create: `tests/unit/.gitkeep`
- Create: `tests/integration/.gitkeep`
- Create: `tests/bench/.gitkeep`
...
```bash
cd D:/.workspace/apex_core
mkdir -p include/apex/core
mkdir -p src
mkdir -p tests/unit
...
touch include/apex/core/.gitkeep
touch src/.gitkeep
touch tests/unit/.gitkeep
touch tests/integration/.gitkeep
touch tests/bench/.gitkeep
...
```bash
git init
git add CMakeLists.txt CMakePresets.json vcpkg.json include/ src/ tests/ examples/ docs/
...
**Files:**
- Create: `include/apex/core/mpsc_queue.hpp`
...
```bash
git add include/apex/core/mpsc_queue.hpp
...
**Files:**
- Create: `include/apex/core/slab_pool.hpp`
...
```bash
git add include/apex/core/slab_pool.hpp
...
**Files:**
- Create: `include/apex/core/ring_buffer.hpp`
...
```bash
git add include/apex/core/ring_buffer.hpp
...
**Files:**
- Create: `include/apex/core/timing_wheel.hpp`
...
```bash
git add include/apex/core/timing_wheel.hpp
...
- 구현 파일: `src/<component>.cpp`
- 테스트 파일: `tests/unit/test_<component>.cpp`
- 테스트 통과 후 커밋
...
**Files:**
- Create: `src/mpsc_queue.cpp` (or header-only in .hpp)
- Create: `tests/unit/test_mpsc_queue.cpp`
- Modify: `tests/unit/CMakeLists.txt` (uncomment test line)
...
```cpp
// tests/unit/test_mpsc_queue.cpp
...
`tests/unit/CMakeLists.txt`에서 해당 라인 uncomment:
```cmake
apex_add_unit_test(test_mpsc_queue test_mpsc_queue.cpp)
```
...
`include/apex/core/mpsc_queue.hpp` 하단에 구현 추가 (template이므로 header-only):
...
```bash
git add include/apex/core/mpsc_queue.hpp tests/unit/test_mpsc_queue.cpp tests/unit/CMakeLists.txt
...
**Files:**
- Create: `src/slab_pool.cpp`
- Create: `tests/unit/test_slab_pool.cpp`
- Modify: `tests/unit/CMakeLists.txt`
- Modify: `CMakeLists.txt` (add src)
...
```bash
git add src/slab_pool.cpp tests/unit/test_slab_pool.cpp tests/unit/CMakeLists.txt CMakeLists.txt
...
**Files:**
- Create: `src/ring_buffer.cpp`
- Create: `tests/unit/test_ring_buffer.cpp`
- Modify: `tests/unit/CMakeLists.txt`
- Modify: `CMakeLists.txt` (add ring_buffer.cpp)
...
`CMakeLists.txt`: `src/ring_buffer.cpp` 추가
`tests/unit/CMakeLists.txt`: uncomment ring_buffer test
...
```bash
git add src/ring_buffer.cpp tests/unit/test_ring_buffer.cpp tests/unit/CMakeLists.txt CMakeLists.txt
...
**Files:**
- Create: `src/timing_wheel.cpp`
- Create: `tests/unit/test_timing_wheel.cpp`
- Modify: `tests/unit/CMakeLists.txt`
- Modify: `CMakeLists.txt` (add timing_wheel.cpp)
...
(src/timing_wheel.cpp — 이중 연결 리스트 기반 슬롯, O(1) insert/remove/tick)
...
```bash
git add src/timing_wheel.cpp tests/unit/test_timing_wheel.cpp tests/unit/CMakeLists.txt CMakeLists.txt
