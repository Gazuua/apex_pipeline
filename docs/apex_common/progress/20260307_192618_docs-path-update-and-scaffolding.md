...
### 작업 내용
- **대상:** 22개 .md 파일 (apex_core/docs/ 20개 + docs/ 2개)
- **치환 건수:** 534건
- **치환 규칙** (긴 패턴 우선 적용):
...
- **추가 수동 갱신:**
  - `docs/apex_common/plans/20260307_175218_directory-structure-design.md` — 디렉토리 트리 플랫 구조로 갱신, CMake 참조 경로 수정
  - `docs/apex_common/progress/20260307_191204_monorepo-restructuring.md` — 미완료 항목 완료 처리
...
### 배경
설계 문서(`docs/apex_common/plans/20260307_175218_directory-structure-design.md`)에 명시된 4개 루트 디렉토리가 미생성 상태였음.
