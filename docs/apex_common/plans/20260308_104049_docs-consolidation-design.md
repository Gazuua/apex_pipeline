...
├── apex_common/                             ← 모노레포 횡단 공통 (plans/progress/review)
├── apex_core/
...
2. **프로젝트 횡단 문서** → `docs/apex_common/` 하위의 `plans/progress/review/`
...
| 파일 | 이유 |
|------|------|
| `Apex_Pipeline.md` | 마스터 설계서 (docs/ 루트 유지) |
| `apex_common/plans/directory-structure-design` | 모노레포 전체 |
| `apex_common/plans/docs-path-update-and-scaffolding` | 모노레포 전체 |
| `apex_common/plans/docs-consolidation-design` (본 문서) | 모노레포 전체 |
| `apex_common/progress/monorepo-restructuring` | 모노레포 전체 |
| `apex_common/progress/docs-path-update-and-scaffolding` | 모노레포 전체 |
| `apex_common/review/docs-path-update-*` (3건) | 모노레포 전체 |
