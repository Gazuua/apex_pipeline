...
| v0.4.5.0 | 중 | 코어 메모리 아키텍처 (BumpAllocator, ArenaAllocator, SlabPool→SlabAllocator 리네임), Redis Multiplexer 전환 (ConnectionPool CRTP 제거), PgTransaction RAII, PgConnection prepared statement, CoreMetrics, PoolLike concept, TOML 설정 스키마 확장 | |
