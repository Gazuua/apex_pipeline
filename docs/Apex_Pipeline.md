...
v0.5.0.0 (완료) ── Wave 1: Protocol concept + 어댑터 회복력
    └──→ v0.5.2~4 (설계/계획 완료, 구현 대기) ── Wave 2: 서비스 체인
         v0.5.2.0 Gateway MVP
         v0.5.2.1 Rate Limiting
         v0.5.3.0 Auth Service
         v0.5.3.1 Chat Service
         v0.5.4.0 E2E 통합 테스트
              └──→ v0.6 ── Wave 3: 운영 인프라
                        └──→ v1.0.0.0 — 프레임워크 완성
                                   └──→ v1.1+ — 게임 레퍼런스
...
#### v0.5: 서비스 체인
- [ ] WebSocket 프로토콜 (Boost.Beast, Protocol concept, ping/pong)
