...
- **현재**: v0.5.5.1 — E2E 인프라 수정 + 서비스 체인 검증 (BUILD_TESTING, 20+ 이슈 수정, 67 유닛 + E2E 1/11 통과)
...
- **작업 완료 후 브랜치 정리**: 모든 작업이 완전히 끝나면 `apex_tools/cleanup-branches.sh --execute` 실행 — 머지 완료 브랜치 + 잔여 워크트리 디렉토리 일괄 정리
