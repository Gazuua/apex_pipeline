...
- **현재**: v0.6.4 — CI/CD 고도화 + SocketBase virtual interface(BACKLOG-133, PR #191) — apex_core OpenSSL 의존 해소, TcpSocket/TlsSocket, Transport concept 확장(ListenerState/wrap_socket). Helm Rollout CRD 지원, 3단계 검증 파이프라인
