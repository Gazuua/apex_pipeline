...
- `apex_docs/plans/20260307_174528_directory-structure-design.md` — 모노레포 구조 설계서
- `apex_docs/progress/20260307_184424_monorepo-restructuring.md` — 진행 현황
...
**파일:** `apex_docs/plans/20260307_174528_directory-structure-design.md`

수동 갱신 필요 사항:
1. **디렉토리 트리 (line 34-41):** `apex_core/core/` 중첩 제거, 플랫 구조로 갱신
2. **CMake 참조 (line 109):** `../../apex_core/core` → `../../apex_core`

**파일:** `apex_docs/progress/20260307_184424_monorepo-restructuring.md`
...
설계 문서(`apex_docs/plans/20260307_174528_directory-structure-design.md`)에 명시된 4개 루트 디렉토리가 미생성 상태:
...
git add apex_docs/progress/20260307_184424_monorepo-restructuring.md
