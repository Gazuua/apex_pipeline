...
│   ├── docs/                         ← 프로젝트별 문서 (plans/progress/review)
...
| Framework | apex_core | 자체 개발 (ServiceBase CRTP) |
...
| 4.6-r | 진행 중 | v0.2.2 코드 리뷰 Important 11건 수정 → v0.2.3 | +5개 예정 |
...
- [ ] v0.2.2 코드 리뷰 수정 (Important 11건) → v0.2.3
